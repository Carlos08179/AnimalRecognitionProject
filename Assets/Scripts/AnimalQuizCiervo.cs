...
public class AnimalQuizCiervo : MonoBehaviour
{
    ...
    private string[] questions = { "¿Dónde vive el ciervo?", "¿Qué come el ciervo?" };
    private string[] correctAnswers = { "Bosques", "Herbívoro" };
